...
public abstract class HttpDeleteAction extends HttpAction {

	private static final Logger log = LoggerFactory.getLogger(HttpDeleteAction.class);
	...
	protected ActionResult doHttpRequest(LoadTestContext cx) throws ClientProtocolException, IOException {
		...
		if(uriString == null) {
			// null means "no delete to perform", return null ActionResult
			return null;
		}
		...
		int requestCount = 1;
		log.debug("Delete of {} complete", uri);
